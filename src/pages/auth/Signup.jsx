...
export default function Signup() {
  ...
  if (isAuthed && profile) {
    const dest = profile.status === 'approved' ? next : '/pending'
    return ownsPath(dest) ? <Navigate to={dest} replace /> : <CrossAppRedirect to={dest} />
  }
    ...
    <AuthLayout
      ...
      footer={
        <>
          Don&apos;t see your org?{' '}
          <Link
            to={withContinueTo('/register-org', next)}
