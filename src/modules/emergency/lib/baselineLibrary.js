// ─────────────────────────────────────────────────────────────────────────────
// The standard baseline emergency response library.
//
// Generic, industry-standard rescue procedures usable by any organization in
// any country. This lives in the app (not in a seed script) so an administrator
// can install it from Emergency Response → Baseline Plans without a developer,
// a terminal or production credentials.
//
...
//   {{role:KEY}} placeholder rendered in the org's own language.
//
...
//   site's own mapped contacts already hold the nearest hospital, police and
//   fire numbers. The national helpline prints on the SOS poster, from Org
//   Settings.
//
// Sites recall these, adapt them locally, then approve them for use.
// ─────────────────────────────────────────────────────────────────────────────
...
export const BASELINE_LIBRARY = PLANS
export const BASELINE_SCENARIO_COUNT = PLANS.length
