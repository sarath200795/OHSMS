 ...
 *
 * Lives in shared because the same 50ms-violation was diagnosed and fixed twice,
 * independently, in fire/ and incidents/ — byte-identical files reached by two
 * separate investigations. A third copy in hira/ carried a different default
 * duration and nothing imported it. One copy is how the next dashboard gets the
 * fix without anyone having to find it again.
 */
